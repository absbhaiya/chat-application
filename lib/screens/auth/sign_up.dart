...
class _SignUpState extends State<SignUp> {
  ...
  void initState() {
    ...
    usernameController.text = "Enter username";
    onUserNameChange();
    super.initState();
  }
          ...
          child: Form(
            ...
            child: ListView(
              children: [
                ...
                Text("Welcome to my", style: TextDesign().dashboardWidgetTitle),
                Text("Chat App", style: TextDesign().popHead.copyWith(color: MyColor.primary, fontSize: 22)),
